...
name='dpo10k-500prompt-eval-epoch1'
ckpt='/home/rliuay/haoyu/research/DPO-videocrafter/results/dpo-10k-fixweights/20240602163049_dpo-10k/checkpoints/epoch=1.ckpt'
config='/home/rliuay/haoyu/research/DPO-videocrafter/configs/train/video_dpo_ft/config.yaml'
# prompt_file="prompts/test_prompts.txt"
prompt_file="prompts/VPD-500-train.txt"
res_dir="results"
